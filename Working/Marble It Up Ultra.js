Game.ExecutableContext = ["Marble It Up_Data"];
...
Game.Hook.ForceFocusWindowName = "Marble It Up_Data";
...
Game.Play = function() {
  ...
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\Bad Habit\\MarbleItUpUltra", "Screenmanager Fullscreen mode_h3630240806", 0, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\Bad Habit\\MarbleItUpUltra", "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\Bad Habit\\MarbleItUpUltra", "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
