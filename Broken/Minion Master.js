...
Game.KillMutex = ["nion-Masters-MinionMasters-exe-SingleInstanceMutex-Default"];
...
Game.ExecutableName = "MinionMasters.exe";
Game.SteamID = "489520";
Game.GUID = "Minion Masters";
Game.GameName = "Minion Masters";
Game.MaxPlayers = 2;
Game.MaxPlayersOneMonitor = 2;
Game.LauncherTitle = "";
Game.Hook.ForceFocusWindowName = "Minion Masters";
Game.FakeFocus = true;
