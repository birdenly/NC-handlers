Game.FileSymlinkCopyInstead = [
   ...
   "StarFlight.uproject",
   "AssetRegistry.bin",
   "DataTableFunctionLibraryLite.uplugin",
   "HelperLib.uplugin",
   "LoadingScreen.uplugin",
   "LowEntryExtStdLib.uplugin",
   "RestartEditor.uplugin",
   "SmoothSyncPlugin.uplugin",
...
Game.ExecutableName = "HarshDoorstop-Win64-Shipping.exe";
Game.SteamID = "736590";
Game.GUID = "HarshDoorstop";
Game.GameName = "HarshDoorstop";
Game.MaxPlayers = 12;
Game.MaxPlayersOneMonitor = 12;
Game.BinariesFolder = "HarshDoorstop\\Binaries\\Win64";
Game.LauncherTitle = "";
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Operation: Harsh Doorstop";
Game.Hook.DInputEnabled = false;
Game.Hook.XInputEnabled = true;
Game.Hook.XInputReroute = false;
Game.Hook.CustomDllEnabled = false;
Game.XInputPlusDll = ["xinput9_1_0.dll","xinput1_4.dll"];
Game.Description =
  "";
