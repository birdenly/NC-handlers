...
Game.UserProfileConfigPath = "Documents\\My Games\\Frontlines - Fuel of War";
...
Game.Play = function() {
  ...
  var savePath = Context.NucleusUserRoot + Context.UserProfileConfigPath + "\\GCGame\\Config\\GCEngine.ini";
  ...
  var savePath = Context.EnvironmentPlayer + Context.UserProfileConfigPath + "\\GCGame\\Config\\GCInput.ini";
  Context.ModifySaveFile(savePath, savePath, Nucleus.SaveType.INI, [
    new Nucleus.IniSaveInfo("Engine.Console", "ConsoleKey", "Tilde"),
    new Nucleus.IniSaveInfo("Engine.Console", "TypeKey", "Tab"),
  ]);
