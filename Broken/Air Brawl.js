Game.ExecutableContext = ["Air Brawl_Data"];
...
Game.ExecutableName = "Air Brawl.exe";
Game.LauncherExe = "Air Brawl.exe";
Game.LauncherTitle = "Air Brawl Configuration";
Game.SteamID = "375600";
Game.GUID = "Air Brawl";
Game.GameName = "Air Brawl";
Game.MaxPlayers = 14;
Game.MaxPlayersOneMonitor = 14;
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Air Brawl";
...
Game.UserProfileSavePath = "AppData\\Roaming\\Goldberg SteamEmu Saves\\375600";
...
Game.Play = function() {
  ...
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\DefaultCompany\\Air Brawl", "Screenmanager Is Fullscreen mode_h3981298716", 0, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\DefaultCompany\\Air Brawl", "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\DefaultCompany\\Air Brawl", "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\DefaultCompany\\Air Brawl", "DoneTut_h232666928", 1, Nucleus.RegType.DWord);
