...
Game.ExecutableName = "shattered_horizon.exe";
Game.SteamID = "18110";
Game.GUID = "Shattered horizon";
Game.GameName = "Shattered horizon";
Game.MaxPlayers = 32;
Game.MaxPlayersOneMonitor = 32;
Game.BinariesFolder = "client_exe";
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Shattered Horizon";
...
Game.UserProfileConfigPath = "AppData\\Local\\Futuremark\\Shattered Horizon";
...
Game.Play = function() {
  ...
  Context.StartArguments = " --connect " + Context.LocalIP

  Context.RunAdditionalFiles(
    ["1|" + Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\server_exe\\sh_server_gui.exe"],
    false,
    "Press 'ok' after you have started the server LAN server.",
    1,
    false,
    false,
    true,
  ...
  var cfgpath = Context.EnvironmentPlayer + Context.UserProfileConfigPath + "\\sh.settings";
  var dict = [
  ...
  if (Context.PlayerID == 0) {
    var cfgpath = Context.EnvironmentPlayer + Context.UserProfileConfigPath + "\\sh.settings";
    var dict = [
      Context.FindLineNumberInTextFile(cfgpath, '        music_volume', Nucleus.SearchType.StartsWith) + '|        music_volume 0.5',
    ];
    Context.ReplaceLinesInTextFile(cfgpath, dict);
    ...
    var cfgpath = Context.EnvironmentPlayer + Context.UserProfileConfigPath + "\\sh.settings";
    var dict = [
      Context.FindLineNumberInTextFile(cfgpath, '        music_volume', Nucleus.SearchType.StartsWith) + '|        music_volume 0.0',
    ];
    Context.ReplaceLinesInTextFile(cfgpath, dict);
