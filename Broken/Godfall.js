...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv151\\Win64", "Aperion\\Binaries\\Win64"];
...
Game.ExecutableName = "Aperion-Win64-Shipping.exe";
// Game.LauncherExe = "EOSAuthLauncher.exe";
// Game.LauncherExeIgnoreFileCheck = true;
// Game.LauncherTitle = "";
Game.SteamID = "928960";
Game.GUID = "Godfall";
Game.GameName = "Godfall";
Game.MaxPlayers = 2;
Game.MaxPlayersOneMonitor = 2;
Game.BinariesFolder = "Aperion\\Binaries\\Win64";
Game.LauncherTitle = "";
// Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Godfall";
...
Game.UserProfileConfigPath = "AppData\\Local\\Aperion\\Saved\\Config\WindowsNoEditor";
...
Game.Play = function() {
  ...
  Context.ModifySaveFile(savePath, savePath, Nucleus.SaveType.INI, [
    new Nucleus.IniSaveInfo("/Script/Aperion.APGameUserSettings", "ResolutionSizeX", Context.Width),
    new Nucleus.IniSaveInfo("/Script/Aperion.APGameUserSettings", "ResolutionSizeY", Context.Height),
    new Nucleus.IniSaveInfo("/Script/Aperion.APGameUserSettings", "LastUserConfirmedResolutionSizeX", Context.Width),
    new Nucleus.IniSaveInfo("/Script/Aperion.APGameUserSettings", "LastUserConfirmedResolutionSizeY", Context.Height),
    new Nucleus.IniSaveInfo("/Script/Aperion.APGameUserSettings", "FullscreenMode", 2),
    new Nucleus.IniSaveInfo("/Script/Aperion.APGameUserSettings", "LastConfirmedFullscreenMode", 2),
    new Nucleus.IniSaveInfo("/Script/Aperion.APGameUserSettings", "PreferredFullscreenMode", 2),
    new Nucleus.IniSaveInfo("/Script/Aperion.APGameUserSettings", "FrameRateLimit", FPS + ".000000")
  ]);

      var jsonPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Aperion\\Binaries\\Win64\\nepice_settings\\NemirtingasEpicEmu.json";// + "\\NemirtingasEpicEmus.json" for stable older epic emu version.
    var params = [
    '{',
    '  "appid": "InvalidAppid",',
