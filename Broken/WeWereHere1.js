...
Game.Description = "Start the game once before and disable fullscreen in the settings. Start a lobby in one screen and join in with the other. If you use keyboards and mice after all the instances open press the END key to lock the input for all instances to have their own cursor. Press the END key again to unlock the input. You can also use CTRL+Q to close Nucleus and all its instances.";
