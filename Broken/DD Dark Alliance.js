Game.KillMutex = ["F91D0330-06A6-4F08-99E6-52C31FE0FB3A"];

Game.ExecutableContext = ["libScePad.dll"];
...
Game.ExecutableName = "DarkAlliance-Win64-Shipping.exe";
Game.SteamID = "623280";
Game.GUID = "Dungeons Dragons Dark Alliance";
Game.GameName = "Dungeons & Dragons: Dark Alliance";
Game.MaxPlayers = 4;
Game.MaxPlayersOneMonitor = 4;
Game.BinariesFolder = "WindowsNoEditor\\CotH\\Binaries\\Win64";
Game.LauncherTitle = "";
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Dark Alliance";
