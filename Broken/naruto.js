...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv157\\Win64"];

Game.HandlerInterval = 500;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = true;
Game.ExecutableName = "NARUTO-Win64-Shipping.exe";
// Game.LauncherExe = "LOTF2.exe";
// Game.LauncherExeIgnoreFileCheck = true;
// Game.LauncherTitle = "";
Game.SteamID = "633230";
Game.GUID = "NARUTO";
Game.GameName = "NARUTO";
Game.MaxPlayers = 2;
Game.MaxPlayersOneMonitor = 2;
Game.BinariesFolder = "NARUTO\\Binaries\\Win64";
Game.LauncherTitle = "";
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "NARUTO TO BORUTO: SHINOBI STRIKER";
...
Game.UserProfileConfigPath = "Saved Games\\NARUTO TO BORUTO SHINOBI STRIKER";
...
Game.Play = function() {
  ...
  var timese = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv157\\Win64\\disable_lan_only.txt";
  var lines = [];
