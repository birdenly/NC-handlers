...
Game.BackupFiles = ["Preferences.xml"];
Game.HandlerInterval = 100;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = false;
Game.ExecutableName = "Bonerooms.exe";
Game.SteamID = "2719940";
Game.GUID = "The Bonerooms";
Game.GameName = "The Bonerooms";
Game.MaxPlayers = 4;
Game.MaxPlayersOneMonitor = 4;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Bonerooms";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\Jasozz Games";
...
Game.Play = function() {
  ...
  var savePath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Bonerooms_Data\\Plugins\\x86_64\\steam_settings\\configs.user.ini";
  ...
  var fillPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Bonerooms_Data\\globalgamemanagers";

  var base = Context.Nickname;
  var og_Path = "Bonerooms";
  ...
  var pref = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Bonerooms_Data\\Preferences.xml";
  Context.ChangeXmlNodeInnerTextValue(pref, "//prefsResX", Context.Width);
  Context.ChangeXmlNodeInnerTextValue(pref, "//prefsResY", Context.Height);
  Context.ChangeXmlNodeInnerTextValue(pref, "//prefsFullscreenMode", "2");

  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\The Bonerooms\\"+newPath, "Screenmanager Fullscreen mode_h3630240806", 0, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\The Bonerooms\\"+newPath, "Screenmanager Fullscreen mode Default_h401710285", 0, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\The Bonerooms\\"+newPath, "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\The Bonerooms\\"+newPath, "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\The Bonerooms\\"+newPath, "Screenmanager Resolution Use Native_h1405027254", 0, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\The Bonerooms\\"+newPath, "Screenmanager Resolution Window Width_h2524650974", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\The Bonerooms\\"+newPath, "Screenmanager Resolution Window Height_h1684712807", Context.Height, Nucleus.RegType.DWord);
};
