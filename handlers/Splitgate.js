...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv151\\Win64", "PortalWars\\Binaries\\Win64"];
...
Game.XInputPlusDll = [];
Game.Description =
  "IMPORTANT: WHEN IN SPLITSCREEN GO INTO SETTINGS AND CHANGE THE INPUT DEVICE (K/M OR CONTROLLER, DEPENDING ON WHAT THE INSTANCE IS), IF IT IS WRONG YOU WONT BE ABLE TO DO ANYTHING IN-GAME.\n\nMake a server/lobby and make sure it isnt private. You will need to alt+tab to the instance to name the server to be able to start it.\n\nAfter all the instances have launched, resized and positioned correctly, press the END key once to lock the input for all instances to have their own working cursor and keyboard. You need to left click each mouse to make the emulated cursors appear after locking the input. Press the END key again to unlock the input when you finish playing. You can also use CTRL+Q to close Nucleus and all its instances when the input is unlocked.";
...
Game.UserProfileConfigPath = "AppData\\Local\\PortalWars\\Saved\\Config";
Game.UserProfileSavePath = "AppData\\Local\\PortalWars\\Saved\\SaveGames";
...
Game.Play = function() {
  ...
  var txtPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\PortalWars\\Binaries\\Win64\\nepice_settings\\NemirtingasEpicEmu.json";
  var dict = [
  ...
  Context.ModifySaveFile(savePath, savePath, Nucleus.SaveType.INI, [
    new Nucleus.IniSaveInfo("/Script/PortalWars.PortalWarsGameUserSettings", "bHasRunAutoCalibration", "True"),
    new Nucleus.IniSaveInfo("/Script/PortalWars.PortalWarsGameUserSettings", "ResolutionSizeX", Context.Width),
    new Nucleus.IniSaveInfo("/Script/PortalWars.PortalWarsGameUserSettings", "ResolutionSizeY", Context.Height),
    new Nucleus.IniSaveInfo("/Script/PortalWars.PortalWarsGameUserSettings", "LastUserConfirmedResolutionSizeX", Context.Width),
    new Nucleus.IniSaveInfo("/Script/PortalWars.PortalWarsGameUserSettings", "LastUserConfirmedResolutionSizeY", Context.Height),
    new Nucleus.IniSaveInfo("/Script/PortalWars.PortalWarsGameUserSettings", "FullscreenMode", 2),
    new Nucleus.IniSaveInfo("/Script/PortalWars.PortalWarsGameUserSettings", "LastConfirmedFullscreenMode", 2),
    new Nucleus.IniSaveInfo("/Script/PortalWars.PortalWarsGameUserSettings", "FrameRateLimit", Context.Options["fps"])
  ]);
};
