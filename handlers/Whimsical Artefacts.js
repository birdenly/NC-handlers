...
Game.ExecutableName = "Whimsical Artefacts.exe";
Game.SteamID = "3604800";
Game.GUID = "Whimsical Artefacts";
Game.GameName = "Whimsical Artefacts";
Game.MaxPlayers = 4;
Game.MaxPlayersOneMonitor = 4;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Whimsical Artefacts";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\Whimsical Artefacts";
...
Game.Play = function() {
  ...
  var savePath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Whimsical Artefacts_Data\\Plugins\\x86_64\\steam_settings\\configs.user.ini";
  ...
  var fillPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Whimsical Artefacts_Data\\globalgamemanagers";

  var base = Context.Nickname;
  var og_Path = "Whimsical Artefacts";
  ...
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\LazyFish Studio\\"+newPath, "Screenmanager Fullscreen mode_h3630240806", 3, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\LazyFish Studio\\"+newPath, "Screenmanager Fullscreen mode Default_h401710285", 3, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\LazyFish Studio\\"+newPath, "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\LazyFish Studio\\"+newPath, "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\LazyFish Studio\\"+newPath, "Screenmanager Resolution Window Width_h2524650974", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\LazyFish Studio\\"+newPath, "Screenmanager Resolution Window Height_h1684712807", Context.Height, Nucleus.RegType.DWord);
};
