...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv153\\Win64", "BronzebeardsTavern\\Binaries\\Win64"];

Game.HandlerInterval = 500;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = true;
Game.ExecutableName = "GameProject-Win64-Shipping.exe";
Game.SteamID = "2422870";
Game.GUID = "Bronzebeards Tavern";
Game.GameName = "Bronzebeards Tavern";
Game.MaxPlayers = 8;
Game.MaxPlayersOneMonitor = 8;
Game.BinariesFolder = "BronzebeardsTavern\\Binaries\\Win64";
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "BronzebeardsTavern";
...
Game.UserProfileConfigPath = "AppData\\Local\\BronzebeardsTavern\\Saved\\Config";
Game.UserProfileSavePath = "AppData\\Local\\BronzebeardsTavern\\Saved\\SaveGames";
...
Game.Play = function() {
  ...
  var filePath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv153\\Win64\\steam_settings";
  ...
  var lines = [
    "3402360=Bronzebeard's Tavern - Dwarven Warriors Mini Pack",
    "3402350=Bronzebeard's Tavern - Cottage Charm Mini Pack",
    "3277600=Bronzebeard's Tavern - Spooky Pack",
    "2899290=Bronzebeard's Tavern - Supporter Pack",
    "2800670=Bronzebeard's Tavern - Founder's Pack"
  ];
