...
Game.ExecutableName = "Tick, Tank, Boom.exe";
Game.SteamID = "2237950";
Game.GUID = "Tick Tank Boom";
Game.GameName = "Tick Tank Boom";
Game.MaxPlayers = 8;
Game.MaxPlayersOneMonitor = 8;
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Tick, Tank, Boom";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\Binoworx";
...
Game.Play = function() {
  ...
  var fillPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Tick, Tank, Boom_Data\\globalgamemanagers";

  var base = Context.Nickname;
  var og_Path = "Tick, Tank, Boom";
