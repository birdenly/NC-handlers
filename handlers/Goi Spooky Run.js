var answers1 = ["30", "60", "75", "120", "144", "0"];
...
Game.DirSymlinkExclusions = ["GOI\\Plugins\\SteamCorePro\\Source\\ThirdParty\\SteamLibrary\\redistributable_bin\\win64",  "GOI\\Binaries\\Win64"];
Game.HandlerInterval = 500;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = true;
Game.ExecutableName = "GOI-Win64-Shipping.exe";
Game.SteamID = "2009310";
Game.GUID = "Goi Spooky Run";
Game.GameName = "Goi Spooky Run";
Game.MaxPlayers = 8;
Game.MaxPlayersOneMonitor = 8;
Game.BinariesFolder = "GOI\\Binaries\\Win64";
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "GOI";
...
Game.XInputPlusDll = [];
Game.Description =
  "IMPORTANT: Start the game once and change some settings before trying split screen.\n\nThe game has very little controller support, most menu are only usable with your mouse\n\nChange your in-game name in the 'Mission & Info' table.\n\nCreate a room, make it PUBLIC and join in with others. The battle royale game mode can only be started with 3+ players\n\nAfter all the instances have launched, resized and positioned correctly, press the END key once to lock the input for all instances to have their own working cursor and keyboard. You need to left click each mouse to make the emulated cursors appear after locking the input. Press the END key again to unlock the input when you finish playing. You can also use CTRL+Q to close Nucleus and all its instances when the input is unlocked.";
...
Game.UserProfileConfigPath = "AppData\\Local\\GOI\\Saved\\Config";
Game.UserProfileSavePath = "AppData\\Local\\GOI\\Saved\\SaveGames";
...
Game.Play = function() {
  ...
  var savePath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\GOI\\Plugins\\SteamCorePro\\Source\\ThirdParty\\SteamLibrary\\redistributable_bin\\win64\\steam_settings\\configs.user.ini";
  ...
  Context.ModifySaveFile(savePath, savePath, Nucleus.SaveType.INI, [
    ...
    new Nucleus.IniSaveInfo("/Script/Engine.GameUserSettings", "sg.ResolutionQuality", "100"),
  ]);
};
