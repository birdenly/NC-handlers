...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv151\\Win64", "HappyPlace\\Binaries\\Win64", "HappyPlace\\Binaries\\Win64"];

Game.HandlerInterval = 500;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = true;
Game.ExecutableName = "HappyPlace-Win64-Shipping.exe";
Game.SteamID = "1472930";
Game.GUID = "Flock";
Game.GameName = "Flock";
Game.MaxPlayers = 4;
Game.MaxPlayersOneMonitor = 4;
Game.BinariesFolder = "HappyPlace\\Binaries\\Win64";
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "FLOCK";
...
Game.XInputPlusDll = [];
Game.Description =
  "Create a character, start a public match on one instance and search a public match on other instances";
...
Game.UserProfileConfigPath = "AppData\\Local\\HappyPlace\\Saved\\Config";
Game.UserProfileSavePath = "AppData\\Local\\HappyPlace\\Saved\\SaveGames";
