...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv147\\Win64", "Hanako\\Binaries\\Win64"];

Game.HandlerInterval = 500;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = true;
Game.ExecutableName = "Hanako-Win64-Shipping.exe";
Game.SteamID = "349510";
Game.GUID = "Hanako Honor and Blade";
Game.GameName = "Hanako Honor and Blade";
Game.MaxPlayers = 24;
Game.MaxPlayersOneMonitor = 24;
Game.BinariesFolder = "Hanako\\Binaries\\Win64";
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Hanako: Honor & Blade";
...
Game.XInputPlusDll = [];
Game.Description =
  "IMPORTANT: Start the game once and change some settings before trying split screen. Skins bought in the main game wont work in split screen.\n\nVertical split makes main menu scale really bad.\n\nALSO DO NOT PRESS SELECT ON A CONTROLLER WHILE IN THE MENU IT JUST CRASHES THE GAME LOL\n\nGo into PLAY > Custom Game > and start a match but DONT MAKE IT LAN. Join in with other with the server browser.\n\nIf you use keyboards and mice after all the instances have launched, resized and positioned correctly, press the END key once to lock the input for all instances to have their own working cursor and keyboard. You need to left click each mouse to make the emulated cursors appear after locking the input. Press the END key again to unlock the input when you finish playing. You can also use CTRL+Q to close Nucleus and all its instances when the input is unlocked.";
...
Game.UserProfileConfigPath = "AppData\\Local\\Hanako\\Saved\\Config";
Game.UserProfileSavePath = "AppData\\Local\\Hanako\\Saved\\SaveGames";
...
Game.Play = function() {
  ...
  Context.ModifySaveFile(savePath, savePath, Nucleus.SaveType.INI, [
    new Nucleus.IniSaveInfo("Settings", "r.setres", Context.Width + 'x' + Context.Height),
    new Nucleus.IniSaveInfo("Settings", "Hanako.MaxFPS", FPS + ".000000")
  ]);
