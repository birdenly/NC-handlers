...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv151\\Win64", "OAR\\Binaries\\Win64"];

Game.HandlerInterval = 500;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = true;
Game.ExecutableName = "OAR-Win64-Shipping.exe";
Game.SteamID = "2551020";
Game.GUID = "One armed robber";
Game.GameName = "One armed robber";
Game.MaxPlayers = 4;
Game.MaxPlayersOneMonitor = 4;
Game.BinariesFolder = "OAR\\Binaries\\Win64";
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "One-armed robber";
...
Game.UserProfileConfigPath = "AppData\\Local\\OAR\\Saved\\Config";
Game.UserProfileSavePath = "AppData\\Local\\OAR\\Saved\\SaveGames";
