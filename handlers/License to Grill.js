...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv157\\Win64", "Engine\\Binaries\\Win64", "MeatGame\\Binaries\\Win64"];
Game.FileSymlinkCopyInstead = ["Settings.json"];
Game.HandlerInterval = 500;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = true;
Game.ExecutableName = "MeatGame-Win64-Shipping.exe";
Game.SteamID = "3884700";
Game.GUID = "License to Grill";
Game.GameName = "License to Grill";
Game.MaxPlayers = 8;
Game.MaxPlayersOneMonitor = 8;
Game.BinariesFolder = "MeatGame\\Binaries\\Win64";
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "License to Grill";
...
Game.BackupFiles = ["MeatGame\\Settings.json"]; 
Game.UseNucleusEnvironment = true;
Game.UserProfileConfigPath = "AppData\\Local\\MeatGame\\Saved\\Config";
Game.UserProfileSavePath = "AppData\\Local\\MeatGame\\Saved\\SaveGames";
...
Game.Play = function() {
  ...
  var txtPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\MeatGame\\Binaries\\Win64\\nepice_settings\\NemirtingasEpicEmu.json";
  var dict = [
