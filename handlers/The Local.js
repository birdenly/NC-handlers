...
Game.ExecutableName = "The Local.exe";
Game.SteamID = "2560050";
Game.GUID = "The Local";
Game.GameName = "The Local";
Game.MaxPlayers = 16;
Game.MaxPlayersOneMonitor = 16;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "The Local";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\JINC\\The Local";
...
Game.Play = function() {
  ...
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\JINC\\The Local", "Screenmanager Fullscreen mode_h3630240806", 3, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\JINC\\The Local", "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\JINC\\The Local", "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\JINC\\The Local", "Screenmanager Resolution Use Native_h1405027254", 0, Nucleus.RegType.DWord);
};
