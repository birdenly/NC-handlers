...
Game.ExecutableName = "STRAFTAT.exe";
Game.SteamID = "2386720";
Game.GUID = "STRAFTAT";
Game.GameName = "STRAFTAT";
Game.MaxPlayers = 2;
Game.MaxPlayersOneMonitor = 2;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "STRAFTAT";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\LemaitreBros\\STRAFTAT";
...
Game.Play = function() {
  ...
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\LemaitreBros\\STRAFTAT", "Screenmanager Fullscreen mode_h3630240806", 3, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\LemaitreBros\\STRAFTAT", "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\LemaitreBros\\STRAFTAT", "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\LemaitreBros\\STRAFTAT", "Screenmanager Resolution Use Native_h1405027254", 0, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\LemaitreBros\\STRAFTAT", "enableVoiceChat_h4016405612", 0, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\LemaitreBros\\STRAFTAT", "isFullscreen_h2797258112", 0, Nucleus.RegType.DWord);
};
