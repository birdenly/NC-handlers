...
Game.BackupFolders = ["Data\\save"];

Game.HandlerInterval = 100;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = false;
Game.ExecutableName = "ECO HOLE.exe";
Game.SteamID = "1676870";
Game.GUID = "ECO HOLE";
Game.GameName = "ECO HOLE";
Game.MaxPlayers = 2;
Game.MaxPlayersOneMonitor = 2;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "ECO HOLE";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\AIHASTO";
...
Game.Play = function() {
  ...
  var fillPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\ECO HOLE_Data\\globalgamemanagers";

  var base = Context.Nickname;
  var og_Path = "ECO HOLE";
  ...
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\AIHASTO\\"+newPath, "Screenmanager Fullscreen mode_h3630240806", 3, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\AIHASTO\\"+newPath, "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\AIHASTO\\"+newPath, "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\AIHASTO\\"+newPath, "Screenmanager Resolution Use Native_h1405027254", 0, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\AIHASTO\\"+newPath, "WindowMode_h1881067946", 1, Nucleus.RegType.DWord);
};
