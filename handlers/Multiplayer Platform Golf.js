...
Game.ExecutableName = "MultiplayerPlatformGolf.exe";
Game.SteamID = "2263920";
Game.GUID = "Multiplayer Platform Golf";
Game.GameName = "Multiplayer Platform Golf";
Game.MaxPlayers = 12;
Game.MaxPlayersOneMonitor = 12;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "MultiplayerPlatformGolf";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\RobotAssembly\\MultiplayerPlatformGolf";
...
Game.Play = function() {
  ...
  var fillPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\MultiplayerPlatformGolf_Data\\globalgamemanagers";

  var base = Context.Nickname;
  var og_Path = "MultiplayerPlatformGolf";
  ...
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\RobotAssembly\\"+newPath, "Screenmanager Fullscreen mode_h3630240806", 3, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\RobotAssembly\\"+newPath, "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\RobotAssembly\\"+newPath, "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\RobotAssembly\\"+newPath, "Screenmanager Resolution Use Native_h1405027254", 0, Nucleus.RegType.DWord);
};
