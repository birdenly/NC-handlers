...
Game.ExecutableName = "Tempest.exe";
Game.SteamID = "1881040";
Game.GUID = "Tempest Pirate Action RPG";
Game.GameName = "Tempest Pirate Action RPG";
Game.MaxPlayers = 8;
Game.MaxPlayersOneMonitor = 8;
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Tempest";
...
Game.XInputPlusDll = [];
Game.Description =
  "IMPORTANT: YOU NEED INTERNET CONNECTION, YOU ARE STILL CONNECTED TO THE MAIN SERVER\n\nThere is full controller support, but it is weird. You may need to go in-game and enable Gamepad for the controllers instances. You can also change UI size in the options.\n\nGet in-game, make sure your in the same region and CREATE your OWN lobby and join with other to avoid problems\n\nIf you use keyboards and mice after all the instances have launched, resized and positioned correctly, press the END key once to lock the input for all instances to have their own working CURSOR and KEYBOARD. You need to left click each mouse to make the emulated cursors appear after locking the input. Press the END key again to unlock the input when you finish playing. You can also use CTRL+Q to close Nucleus and all its instances when the input is unlocked.";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\LionsShade";
...
Game.Play = function() {
  ...
  if(!System.IO.Directory.Exists(Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Tempest_Data\\Plugins\\x86_64\\steam_settings")){
    var filePath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Tempest_Data\\Plugins\\x86_64\\steam_settings";
    System.IO.Directory.CreateDirectory(filePath); 
  }

  var dlc = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Tempest_Data\\Plugins\\x86_64\\steam_settings\\DLC.txt";
  var lines = [
  "1073630=Tempest - Pirate City",
  "746820=Tempest - Jade Sea",
  "651020=Tempest - Treasure Lands",
  ];

  Context.WriteTextFile(dlc, lines);

  var fillPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Tempest_Data\\globalgamemanagers";
