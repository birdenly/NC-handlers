Game.ExecutableContext = ["Scrapnaut_Data"];
...
Game.ExecutableName = "Scrapnaut.exe";
Game.SteamID = "1323900";
Game.GUID = "Scrapnaut";
Game.GameName = "Scrapnaut";
Game.MaxPlayers = 4;
Game.MaxPlayersOneMonitor = 4;
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Scrapnaut";
...
Game.Play = function() {
  ...
  var fillPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Scrapnaut_Data\\globalgamemanagers";

  var base = Context.Nickname;
  var og_Path = "Scrapnaut";
  ...
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\SpiffyBit\\"+newPath, "Screenmanager Fullscreen mode_h3630240806", 3, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\SpiffyBit\\"+newPath, "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\SpiffyBit\\"+newPath, "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKey("HKEY_CURRENT_USER", "SOFTWARE\\SpiffyBit\\"+newPath, "Screenmanager Resolution Use Native_h1405027254", 0, Nucleus.RegType.DWord);
