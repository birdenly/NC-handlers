Game.FileSymlinkExclusions = ["steam_api64.dll", "steam_appid.txt","EOSSDK-Win64-Shipping.dll","Rewired_DirectInput.dll","Rewired_WindowsGamingInput.dll"];
...
Game.ExecutableName = "TemtemSwarm.exe";
Game.SteamID = "2510960";
Game.GUID = "Temtem Swarm";
Game.GameName = "Temtem Swarm";
Game.MaxPlayers = 3;
Game.MaxPlayersOneMonitor = 3;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Temtem Swarm";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\Crema";
...
Game.Play = function() {
  ...
  var savePath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\TemtemSwarm_Data\\Plugins\\x86_64\\steam_settings\\configs.user.ini";
  ...
  var txtPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\nepice_settings\\NemirtingasEpicEmu.json";
  var dict = [
  ...
  var fillPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\TemtemSwarm_Data\\globalgamemanagers";

  var base = Context.Nickname;
  var og_Path = "TemtemSwarm";
  ...
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\Crema\\"+newPath, "Screenmanager Fullscreen mode_h3630240806", 3, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\Crema\\"+newPath, "Screenmanager Fullscreen mode Default_h401710285", 3, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\Crema\\"+newPath, "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\Crema\\"+newPath, "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
