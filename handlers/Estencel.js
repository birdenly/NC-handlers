...
Game.ExecutableName = "Estencel-Win64-Shipping.exe";
Game.SteamID = "2025320";
Game.GUID = "Estencel";
Game.GameName = "Estencel";
Game.MaxPlayers = 8;
Game.MaxPlayersOneMonitor = 8;
Game.BinariesFolder = "Estencel\\Binaries\\Win64";
Game.LauncherTitle = "";
Game.HideTaskbar = true;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Estencel";
...
Game.XInputPlusDll = [];
Game.Description =
  "Working for both the demo and the full game.\n\nIn the main menu go into Multiplayer > Information , follow the steps there to start a server/join the other players.\n\nFor keyboard/mouse instance, use the keyboard to navigate the menus\n\nIf you use keyboards and mice after all the instances have launched, resized and positioned correctly, press the END key once to lock the input for all instances to have their own working cursor and keyboard. You need to left click each mouse to make the emulated cursors appear after locking the input. Press the END key again to unlock the input when you finish playing. You can also use CTRL+Q to close Nucleus and all its instances when the input is unlocked";
...
Game.UserProfileConfigPath = "AppData\\Local\\Estencel";
...
Game.Play = function() {
  var Args = (Context.Args = " -windowed " + " -AlwaysFocus " + " -ResX= " + Context.Width + " -ResY= " + Context.Height + " -dx11");

  Context.StartArguments = Args;

  var savePath = Context.EnvironmentPlayer + Context.UserProfileConfigPath + "\\Saved\\Config\\Windows\\GameUserSettings.ini";
