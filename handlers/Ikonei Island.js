...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv151\\Win64", "Castaway\\Binaries\\Win64\\RedpointEOS", "Castaway\\Binaries\\Win64"];

Game.HandlerInterval = 500;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = true;
Game.ExecutableName = "IkoneiIsland-Win64-Shipping.exe";
Game.SteamID = "1550730";
Game.GUID = "Ikonei Island An Earthlock Adventure";
Game.GameName = "Ikonei Island An Earthlock Adventure";
Game.MaxPlayers = 4;
Game.MaxPlayersOneMonitor = 4;
Game.BinariesFolder = "Castaway\\Binaries\\Win64";
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Ikonei Island";
...
Game.XInputPlusDll = [];
Game.Description =
  "Start your main game once before trying split screen.\n\nIn the multiplayer settings set the permission to join to 'Friends Only' and Start a game and join with others. If one instance is laggy, press ctrl+h\n\nAfter all the instances have launched, resized and positioned correctly, press the END key once to lock the input for all instances to have their own working cursor and keyboard. You need to left click each mouse to make the emulated cursors appear after locking the input. Press the END key again to unlock the input when you finish playing. You can also use CTRL+Q to close Nucleus and all its instances when the input is unlocked.";
...
Game.UserProfileConfigPath = "AppData\\Local\\Castaway\\Saved\\Config";
Game.UserProfileSavePath = "AppData\\Local\\Castaway\\Saved\\SaveGames";
...
Game.Play = function() {
  ...
  var txtPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Castaway\\Binaries\\Win64\\nepice_settings\\NemirtingasEpicEmu.json";
  var dict = [
  ...
  Context.ModifySaveFile(savePath, savePath, Nucleus.SaveType.INI, [
    new Nucleus.IniSaveInfo("/Script/Castaway.IkoneiGameUserSettings", "ResolutionSizeX", Context.Width),
    new Nucleus.IniSaveInfo("/Script/Castaway.IkoneiGameUserSettings", "ResolutionSizeY", Context.Height),
    new Nucleus.IniSaveInfo("/Script/Castaway.IkoneiGameUserSettings", "LastUserConfirmedResolutionSizeX", Context.Width),
    new Nucleus.IniSaveInfo("/Script/Castaway.IkoneiGameUserSettings", "LastUserConfirmedResolutionSizeY", Context.Height),
    new Nucleus.IniSaveInfo("/Script/Castaway.IkoneiGameUserSettings", "FullscreenMode", 2),
    new Nucleus.IniSaveInfo("/Script/Castaway.IkoneiGameUserSettings", "LastConfirmedFullscreenMode", 2)
  ]);
};
