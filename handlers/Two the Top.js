Game.FileSymlinkExclusions = ["steam_api64.dll", "steam_appid.txt", "Rewired_DirectInput.dll", "Rewired_WindowsGamingInput.dll"
];
...
Game.ExecutableName = "Two Jumpers.exe";
Game.SteamID = "3525360";
Game.GUID = "Two the Top";
Game.GameName = "Two the Top";
Game.MaxPlayers = 2;
Game.MaxPlayersOneMonitor = 2;
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "Two Jumpers";
...
Game.UserProfileSavePath = "AppData\\LocalLow\\James Sutton";
...
Game.Play = function() {
  ...
  var savePath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Two Jumpers_Data\\Plugins\\x86_64\\steam_settings\\configs.user.ini";
  ...
  var fillPath = Context.GetFolder(Nucleus.Folder.InstancedGameFolder) + "\\Two Jumpers_Data\\globalgamemanagers";

  var base = Context.Nickname;
  var og_Path = "Two the Top";
  ...
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "Screenmanager Fullscreen mode_h3630240806", 3, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "Screenmanager Fullscreen mode Default_h401710285", 3, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "Screenmanager Resolution Width_h182942802", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "Screenmanager Resolution Height_h2627697771", Context.Height, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "Screenmanager Resolution Use Native_h1405027254", 0, Nucleus.RegType.DWord);

  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "Fullscreen_h2248877754", 0, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "ResX_h2089376505", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "ResY_h2089376504", Context.Height, Nucleus.RegType.DWord);

  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "Screenmanager Resolution Window Width_h2524650974", Context.Width, Nucleus.RegType.DWord);
  Context.EditRegKeyNoBackup("HKEY_CURRENT_USER", "SOFTWARE\\James Sutton\\"+newPath, "Screenmanager Resolution Window Height_h1684712807", Context.Height, Nucleus.RegType.DWord);
