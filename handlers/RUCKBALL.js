...
Game.DirSymlinkExclusions = ["Engine\\Binaries\\ThirdParty\\Steamworks\\Steamv139\\Win64", "SumologyThrowBall\\Binaries\\Win64"];

Game.HandlerInterval = 500;
Game.SymlinkExe = false;
Game.SymlinkGame = true;
Game.SymlinkFolders = true;
Game.ExecutableName = "SumologyThrowBall-Win64-Shipping.exe";
Game.SteamID = "645230";
Game.GUID = "Ruckball";
Game.GameName = "Ruckball";
Game.MaxPlayers = 8;
Game.MaxPlayersOneMonitor = 8;
Game.BinariesFolder = "SumologyThrowBall\\Binaries\\Win64";
Game.Hook.ForceFocus = false;
Game.Hook.ForceFocusWindowName = "SumologyThrowBall";
...
Game.XInputPlusDll = [];
Game.Description =
  "IMPORTANT: Start the game once and change some settings before trying split screen. Also the game has a problem where commands will linger with gamepad (also happens with the main game), nothing nucleus can do.\n\nGo into Play > Custom > either create a game or join. (you will need to use your mouse to join/create lobby)\n\nIf you use keyboards and mice after all the instances have launched, resized and positioned correctly, press the END key once to lock the input for all instances to have their own working cursor and keyboard. You need to left click each mouse to make the emulated cursors appear after locking the input. Press the END key again to unlock the input when you finish playing. You can also use CTRL+Q to close Nucleus and all its instances when the input is unlocked.";
...
Game.UserProfileConfigPath = "AppData\\Local\\SumologyThrowBall\\Saved\\Config";
Game.UserProfileSavePath = "AppData\\Local\\SumologyThrowBall\\Saved\\SaveGames";
